...
import { Sun, ChevronDown, MoonIcon } from 'lucide-react'
...
import LayoutBreadcrumb from '../dashboard/layoutBreadcrumb'
        ...
        <main className="flex flex-col h-full overflow-y-hidden">
          ...
          <SidebarProvider>
            ...
            <SidebarInset className="flex-1 flex flex-col">
                ...
                <div className="mr-6">
                  <Select>
                    ...
                    <SelectContent className="w-fit">
                      <SelectItem className="w-fit" value="light mode">
                        <Sun></Sun>
                      </SelectItem>
                      <SelectItem value="dark mode" className="w-fit">
                        <MoonIcon></MoonIcon>
                      </SelectItem>
                    </SelectContent>
                  </Select>
              ...
              {/* Main Content */}
              {/* <section className='flex flex-row w-full md:w-1/2 h-full self-center'>
                <Outlet/>
              </section> */}
              <Outlet />
            </SidebarInset>
